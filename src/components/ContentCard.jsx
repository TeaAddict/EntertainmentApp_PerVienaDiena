...
export default function ContentCard({
  ...
  return (
    <div>
      ...
      type === "Shows" ? (
        <div
          className="items-center w-fit bg-movie-secondary border-none rounded-lg  dark:bg-movie-secondary dark:border-movie-secondary"
          key={content.title}
        >
          <div className="relative">
            <div>
          ...
          <div className="w-full pt-1 desktop:pt-2">
            {/* DESCRIPTION TEXT */}
