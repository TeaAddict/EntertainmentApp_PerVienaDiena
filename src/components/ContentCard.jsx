    ...
    <div className="items-center bg-movie-secondary">
      <div className="relative">
        ...
        <div className="w-full pt-[8px] md:pt-[6px]">
          <p className="font-thin text-white flex items-center text-[11px] md:text-body-s desktop:text-body-s md:pb-[1px]">
            ...
            <img
              ...
              className="inline-block w-[10px] h-[10px] md:w-[12px] md:h-[12px] mr-[4px] md:mr-[6px]"
            />
            <span className="pr-[8px]">{content.category}</span>
            <span className="pr-[5px] md:pr-[8px]">•</span>
            <span>{content.ageRating}</span>
          </p>
          <h5 className="text-white text-body-m md:text-heading-xs tracking-[-0.4px] md:tracking-[0] desktop:text-heading-xs">
            {content.title}
