...
const Header = () => {
  return (
    <header className="desktop:sticky desktop:top-0 desktop:z-10">
      <nav className="  bg-movie-fourth md:rounded-[0.63rem] grid grid-cols-3 items-center desktop:grid desktop:grid-rows-[auto_1fr_auto] desktop:grid-cols-1 md:w-[44.9375rem] md:h-[4.5rem] desktop:w-[6rem] desktop:h-full desktop:rounded-[1.25rem]">
