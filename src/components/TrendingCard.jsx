...
export default function TrendingCard({ content }) {
  ...
  return (
    <div className="relative">
      <div className="group relative bg-cover bg-no-repeat bg-center">
        <picture>
          <source
          ...
          />
          <img
            className="w-[15rem] md:w-[29.375rem] desktop:w-[29.38rem] "
      ...
      <div className="sticky bg-gradient-custom bottom-0 py-[0.99rem] px-4 md:py-[1.3rem] md:px-6  desktop:px-[1.5rem] desktop:py-[1.31rem] flex flex-col justify-end ">
        <div className="text-xs sm:text-[0.9375rem] opacity-75 flex items-center gap-[0.39rem] md:gap-[0.4rem] desktop:gap-[0.4rem]">
